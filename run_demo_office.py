...
class SimEnv:
    ...
    def create_env(self):
        # set design asset
        self.office_env_manager.set_current_robot_asset()
        # self.ur_dof_props = self.office_env_manager.current_env.ur_dof_props
        # self.num_ur_dofs = self.office_env_manager.current_env.num_ur_dofs
        # self.default_dof_pos = self.office_env_manager.current_env.default_dof_pos
        # self.default_dof_state = self.office_env_manager.current_env.default_dof_state
        # self.ur_gripper_index = self.office_env_manager.current_env.ur_gripper_index
        ...
        self.office_env_manager.set_current_interior_asset()
        self.office_env_manager.set_current_object_asset()
        ...
        for i in range(self.num_envs):
            ...
            # add ur5e
            # self.office_env_manager.create_current_robot(env, i)
            # ur_handle = self.office_env_manager.current_env.ur_handle
            ...
            self.office_env_manager.create_current_assets(env, i)
